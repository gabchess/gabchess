...
| [**gtm-tam-mapper**](https://github.com/gabchess/gtm-tam-mapper) | MIT, open source | Turns 75 raw company rows into 40 deduped, tiered accounts (tiers 8/12/13) and 7 named disqualifications, sourced across 3 lists. |
| [**gtm-outbound-personalizer**](https://github.com/gabchess/gtm-outbound-personalizer) | MIT, open source | Turns a master positioning doc and a 12-account list into per-tier outbound variants; QA gate blocks rows missing a named pain point. |
